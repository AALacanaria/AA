...
//Functions
//Shortcut keys for next and previous page
function move(e) {
	//Go previous page when pressed left-arrow key
	if (e.keyCode == 37) {
		goPrevPage();
		//Go next page when pressed right-arrow key
	} else if (e.keyCode == 39) {
		goNextPage();
	}
}

//Transition when book is opened
function openBook() {
